...
const sizesData = [
  { id: 1, label: 'XS', category: 'Clothing', products: 45, color: '#ec4899', bg: '#fdf2f8' },
  { id: 2, label: 'S', category: 'Clothing', products: 98, color: '#ec4899', bg: '#fdf2f8' },
  { id: 3, label: 'M', category: 'Clothing', products: 156, color: '#ec4899', bg: '#fdf2f8' },
  { id: 4, label: 'L', category: 'Clothing', products: 142, color: '#ec4899', bg: '#fdf2f8' },
  { id: 5, label: 'XL', category: 'Clothing', products: 98, color: '#ec4899', bg: '#fdf2f8' },
  { id: 6, label: 'XXL', category: 'Clothing', products: 67, color: '#ec4899', bg: '#fdf2f8' },
  { id: 7, label: '38', category: 'Shoes', products: 34, color: '#3b82f6', bg: '#eff6ff' },
  { id: 8, label: '39', category: 'Shoes', products: 56, color: '#3b82f6', bg: '#eff6ff' },
  { id: 9, label: '40', category: 'Shoes', products: 78, color: '#3b82f6', bg: '#eff6ff' },
  { id: 10, label: '41', category: 'Shoes', products: 65, color: '#3b82f6', bg: '#eff6ff' },
  { id: 11, label: '42', category: 'Shoes', products: 43, color: '#3b82f6', bg: '#eff6ff' },
];
